...
```
Get-DeployPropertiesHash [[-action] <String>] [[-TargetServerName] <String>] [[-TargetDatabaseName] <String>]
 [[-TargetUser] <String>] [[-TargetPasswordSecure] <SecureString>] [[-TargetIntegratedSecurity] <String>]
 [[-ServiceObjective] <Object>] [[-PublishFile] <String>] [[-Variables] <String[]>] [[-TargetTimeout] <String>]
 [[-dacpacfile] <String>] [[-dacpacname] <String>] [[-SettingsToCheck] <Hashtable>] [[-extras] <Object>]
 [<CommonParameters>]
```
